...
class ExperimentGenerator(object):
    ...
    def __init__(self, **kwargs):
        required_attributes = ["distribution_builder", "usage_builder", "workload_builder", "premium_builder"]
        ...
        self.premium_builder=kwargs["premium_builder"]
    ...
    def gen(self, **kwargs):
        ...
        self.premium_builder.attribute_premium_level_to_vm_list(vm_list)
        ...
        for additional_scope in range(1, kwargs["number_of_scope"]):
            ...
            self.premium_builder.attribute_premium_level_to_vm_list(additional_vm)
