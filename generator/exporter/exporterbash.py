...
class ExporterBash(object):
    ...
    def __vm_setup_command(self, vm : VmModel, folder : str):
        return folder + "setupvm.sh " + vm.get_name() + " " + str(vm.get_cpu()) + " " + str(vm.get_mem()) + " " + vm.get_premium_level() + " " + vm.get_workload() + " ; "
    ...
    def __vm_start_command(self, vm : VmModel, folder : str):
        return folder + "startvm.sh " + vm.get_name() + " " + str(vm.get_cpu()) + " " + str(vm.get_mem()) + " " + vm.get_premium_level() + " " + vm.get_workload() + " ; "
