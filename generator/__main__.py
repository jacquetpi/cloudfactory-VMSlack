...
from generator.premiumbuilder import PremiumBuilder
...
yaml_file_premium_default = "examples-scenario/scenario-vm-premium.yml"
...
def print_usage():
    ...
    print("[--premium={premium.yml}]               : premium levels (as yaml file) location. Default :", yaml_file_premium_default)
...
if __name__ == '__main__':
    ...
    short_options = "hd:u:w:p:c:m:v:l:t:o:e:"
    long_options = ["help", "distribution=", "usage=", "workload=", 'premium=', 'cpu=', 'mem=', 'vm=', 'load=', 'temporality=', 'output=', 'export=']
    ...
    yaml_file_premium = yaml_file_premium_default
    init_cpu  = None
    init_mem  = None
    init_vm   = None
    vm_list   = list()
    ...
    for current_argument, current_value in arguments:
        ...
        elif current_argument in('-p', '--premium'):
            yaml_file_premium = current_value
    ...
    try:
        ...
        premium_builder = PremiumBuilder(yaml_file=yaml_file_premium)
        workload_builder = WorkloadBuilder(yaml_file=yaml_file_workload, slice_duration=temporality_slice_duration)

        generator = ExperimentGenerator(distribution_builder=distribution_builder, usage_builder=usage_builder,\
                        premium_builder=premium_builder, workload_builder=workload_builder)
