...
if (( "$#" != "5" )) 
then
  echo -n "Missing argument : ./setupvm.sh name core mem oversub image"
  exit -1
fi
image=""
case $5 in
...
# Setup : install data
curl "http://127.0.0.1:8099/deploy?name=$1&cpu=$2&mem=$3&oc=$4&qcow2=$pathbase/$1.qcow2"
